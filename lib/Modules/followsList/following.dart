                          ...
                          return
                            ...
                            InkWell(
                              onTap: (){
                                ...
                                CubitMainScreen.get(context).getShortProfileUserPostandProjects(userId: CubitMainScreen.get(context).followingProfile[index].id);
                                CubitMainScreen.get(context).getUserAllProjectInProfileFront(userId: CubitMainScreen.get(context).followingProfile[index].id);
